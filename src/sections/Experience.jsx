      ...
      >
        <div className="sticky top-0 h-screen flex flex-col">
          ...
          <div className="shrink-0 px-4 sm:px-6 pt-6 sm:pt-8">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-semibold mt-3 sm:mt-5 text-center">
              Experience
            </h2>
          </div>
          {/* Timeline container */}
          <div className="flex-1 flex items-center justify-center px-4 sm:px-6 pb-8 sm:pb-10">
            ...
            <div className="relative w-full max-w-md md:hidden">
              ...
              <div className="absolute left-0 top-0 bottom-0 w-[1.56px] bg-white/15 rounded">
                <motion.div
